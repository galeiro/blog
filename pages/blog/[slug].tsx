...
export default function Post({ post, related }: PostProps) {
  const seoTitle = `${post.title} | Galeiro's Docs`;
  const seoDesc = `${post.summary}`;
  const url = `https://blog.musex.my.id/blog/${post.slug}`;
      ...
      <NextSeo
        ...
        openGraph={{
          ...
          images: [
            {
              url: post.og
                ? `https://blog.musex.my.id${post.og}`
          ...
          article: {
            ...
            authors: ["https://blog.musex.my.id"],
          },
        }}
      />
      ...
      <div className="flex flex-col gap-20">
        ...
        {related.length ? (
          <div className="flex flex-col items-start gap-10">
            <h3 className="text-xl">Postingan lainnya</h3>
