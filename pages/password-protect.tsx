...
//           <div className="flex items-center py-2 px-3 rounded-2xl gap-7">
...
//                 <input className="pl-2 flex flex-col outline-none border-none " type="text" name="password" placeholder="Password" />
